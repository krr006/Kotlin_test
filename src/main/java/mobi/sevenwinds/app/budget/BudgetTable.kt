...
class BudgetEntity(id: EntityID<Int>) : IntEntity(id) {
    ...
    fun toResponse(fullName: String? = null, date: String? = null): BudgetRecord {
        return BudgetRecord(year, month, amount, type, authorId, authorFullName = fullName, authorDate = date)
    }
}